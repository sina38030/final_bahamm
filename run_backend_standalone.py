#!/usr/bin/env python3
"""
Standalone FastAPI Backend Server for Bahamm App
Run this script from your laptop terminal to start the backend on localhost:8001
Uses bahamm1.db database from the project root
"""
